...
function getEthereumPayload(dest, statement, options) {
    ...
    const prefix = util_1.u8aToString((_b = (_a = constants === null || constants === void 0 ? void 0 : constants.claims) === null || _a === void 0 ? void 0 : _a.prefix) === null || _b === void 0 ? void 0 : _b.toU8a(true));
